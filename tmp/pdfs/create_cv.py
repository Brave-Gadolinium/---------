...
PORTFOLIO = [
    {
        ...
        "context": {"en": "A party of up to four players enters a separate nightmare world and tries to survive escalating nights while rescuing Tommy.", "ru": "Пати до четырёх игроков перемещается в отдельный мир кошмара и переживает усложняющиеся ночи, приближаясь к спасению Томми."},
        "contribution": {"en": "Gameplay and production systems for the cooperative survival loop.", "ru": "Игровые и продакшен-системы для кооперативного цикла выживания."},
        "systems": {"en": "Party and teleport flow; base building and upgrades; anomalies; exploration and combat.", "ru": "Пати и телепортация; строительство и улучшение базы; аномалии; исследование и бой."},
    ...
    },
    {
        ...
        "context": {"en": "Players train strength, evolve fireballs, collect pets and compete for King of the Hill.", "ru": "Игроки тренируют силу, развивают огненные шары, собирают питомцев и сражаются за вершину холма."},
        "contribution": {"en": "Development of interconnected progression and gameplay systems.", "ru": "Разработка связанных систем прогрессии и геймплея."},
        "systems": {"en": "Training; fireball evolution; pets; PvP; persistent progress; social bonuses.", "ru": "Тренировки; эволюция огненных шаров; питомцы; PvP; сохранения; социальные бонусы."},
    ...
    },
    {
        ...
        "context": {"en": "A plot-based tycoon where workers produce cards that players collect and sell to expand their empire.", "ru": "Тайкун на личном участке: работники создают карты, которые игрок собирает и продаёт для развития империи."},
        "contribution": {"en": "Supported the released project and developed production updates for its live audience.", "ru": "Поддерживал выпущенный проект и разрабатывал продакшен-обновления для действующей аудитории."},
        "systems": {"en": "Worker shop; plot placement; collect-and-sell economy; offline earnings.", "ru": "Магазин работников; размещение на участке; экономика сбора и продажи; офлайн-доход."},
    ...
    },
    {
        ...
        "role": {"en": "Roblox Developer", "ru": "Roblox-разработчик"},
        "context": {"en": "Players blast through underground layers, recover rare units and return them to a personal base.", "ru": "Игроки взрывают подземные слои, находят редких юнитов и возвращают их на личную базу."},
        "contribution": {"en": "Development of the mining, progression and base-economy gameplay loop.", "ru": "Разработка игрового цикла раскопок, прогрессии и экономики базы."},
        "systems": {"en": "Depth-based digging; bomb upgrades; unit slots and income; events, PvP and leaderboards.", "ru": "Раскопки по глубине; улучшение бомб; слоты и доход юнитов; события, PvP и рейтинги."},
    ...
    },
    {
        ...
        "role": {"en": "Roblox Developer", "ru": "Roblox-разработчик"},
        "context": {"en": "Players fly with a bubble-gum balloon, avoid hazards, collect units and return them to base.", "ru": "Игроки летают на пузыре, избегают опасностей, собирают юнитов и возвращают их на базу."},
        "contribution": {"en": "Development of movement, collection, progression and base systems.", "ru": "Разработка систем передвижения, коллекционирования, прогрессии и базы."},
        "systems": {"en": "Bubble flight; tsunami hazards; Lucky Blocks; rebirths; base slots; offline income.", "ru": "Полёт на пузыре; цунами; Lucky Blocks; перерождения; слоты базы; офлайн-доход."},
