...
Основные персональные данные, статус доступности, студии, навыки и контакты находятся в `data/site.ts`. Контакты редактируются в массиве `siteConfig.contacts`; Discord отсутствует и поэтому не отображается.
